...
Remember that by default, everything that the DPhi Pods print to the console, be it standard output or errors, will not be saved by our system. It is the responsibility of the user to log to the mounted volume `/data` everything they wish to keep persistent accross runs and downlinkable.
...
1. [**Telemetry Client API**](/docs/5-examples/1-telemetry.md)
...
1. [**Fisheye Telemetry Analysis**](/docs/5-examples/2-fisheye-gpu.md)
...
1. [**Dashboard Workflow**](/docs/5-examples/3-dashboard-pipeline.md)
  This example guides the user on a simple operation design and deployment on Clustergate-2's Engineering Model. It runs a DPhi pod and downlinks a file it generates onboard.
