...
An ollama server will be running on GPU to easify interactions with some preloaded LLMs, please have a look [here](/docs/1-howto/4-ollama.md) to have more details.
