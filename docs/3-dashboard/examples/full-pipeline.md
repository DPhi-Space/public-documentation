...
![Operation List](../imgs/examples/create-operation.png)
Operation list view.

![Operation Create](../imgs/examples/create-operation-2.png)
...
![Operation Create](../imgs/examples/operation-edit.png)
Operation edit view.
...
![Operation Execute](../imgs/examples/operation-execute.png)
